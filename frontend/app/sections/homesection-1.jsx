          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
            ...
            <div className="lg:w-1/2 space-y-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-10">
                ...
                <Link
                  href="/auth/register"
                  className="inline-block px-8 py-3 bg-gradient-to-r from-violet-900 via-violet-500 to-blue-500 text-white font-medium rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.03]"
                >
                  Get Started
                </Link>
