...
const MobileLogin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await api.post('/patient/send-otp', { mobile });
      console.log('OTP API response:', response.data);

      // Save mobile number to sessionStorage for OTP page
      sessionStorage.setItem('phone', mobile);

      // Decide flow: registration or login based on current route
