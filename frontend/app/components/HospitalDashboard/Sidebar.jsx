...
import DoctorDashboardNavbar from '../DoctorDashboard/DoctorDashNav'
import {
    QrCode,
    FileText,
    Calendar,
    ...
    const sidebarItems = [
        ...
        },
        {
            ...
            dropdownItems: [
                ...
                {
                    label: "Prescriptions",
                    href: "/dashboard/patient/records/prescription/prescription-records",
                },
                {
                    label: "Medical History",
                    href: "/dashboard/patient/records/medicalHistory",
                },
                {
                    label: "Vaccination Records",
                    href: "/dashboard/patient/records/vaccination/vaccination-records",
                },
                 {
                    label: "Doctor Notes",
                    href: "/dashboard/patient/records/doctor-notes/note-form",
                },
                  {
                    label: "Medical Expenses",
                    href: "/dashboard/patient/records/medical-expence/expence-records",
                },
