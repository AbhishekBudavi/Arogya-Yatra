...
const reportData = {
  ...
  const handleViewReport = (id) =>{
    ...
    router.push(`/dashboard/patient/records/labreports/${id}`);
  };
          ...
          <div className="w-full max-w-xl mx-auto transition-all duration-500 transform">
            <div className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
              ...
              <div className="p-6 space-y-3">
                <button onClick={() => handleViewReport(reportData.id)}  className="w-full bg-blue-600 text-white py-3 px-4 rounded-lg font-medium hover:bg-blue-700 transition-colors flex items-center justify-center">
