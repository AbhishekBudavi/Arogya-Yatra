...
const DoctorNoteLandingPage = ({ goBack, addRecords }) => {
...
//   }, []);
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 md:p-6 lg:p-8">
      ...
      <h1 className="text-3xl font-bold text-gray-900 mb-6">Your Doctor Notes</h1>
      ...
      <div className="flex flex-col md:flex-row gap-4 mb-6">
        ...
        <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6">
          ...
          {addRecords && (
            <Link href="/dashboard/patient/records/doctor-notes/note-form">
...
export default DoctorNoteLandingPage ;
