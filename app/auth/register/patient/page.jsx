    ...
    return (
        <section className="mt-10 flex justify-center items-center min-h-screen bg-[#F2EFFE] px-2 sm:px-4 md:px-8">
            <div className="w-full max-w-md bg-white rounded-2xl shadow-lg pt-8 px-4 sm:pt-10 sm:px-8 md:px-10 pb-6 sm:pb-8 tracking-wide">
                <h4 className="text-[20px] sm:text-[23px] font-semibold mb-2 text-black tracking-wide">Login or Create Account</h4>
                ...
                <form onSubmit={handleSubmit}>
                    <div className="mb-5">
                        ...
                        >
                            <span className="px-3 sm:px-4 py-2 border-r-2 border-gray-400 bg-white text-gray-600 font-semibold whitespace-nowrap text-sm sm:text-base">+91</span>
                            <input
                                type="tel"
