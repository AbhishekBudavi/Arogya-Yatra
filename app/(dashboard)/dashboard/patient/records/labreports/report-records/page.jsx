...
const LabReportsPage = () => {
  ...
  const reportIds = ['RPT-00891', 'RPT-00892']; // Add more if needed
          ...
          {filteredReports.map((report) => (
            <div key={report.id} className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100">
              ...
              <div className="px-6 py-4 bg-gray-50 border-t flex justify-between items-center">
                ...
                <Link  href={`/dashboard/patient/records/labreports/${report.id}`}  className="px-4 py-2 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-colors duration-200">
                  View Details
                </Link>
